...
const Tasks = () => {
  ...
  // filter pending tasks, progress tasks, complete tasks
  const pendingTasks = tasks ? tasks.filter(item => item.status === 'pending') : [];
  const progressTasks = tasks ? tasks.filter(item => item.status === 'in progress') : [];
  const completeTasks = tasks ? tasks.filter(item => item.status === 'complete') : [];
  ...
  return (
    <div className="h-screen grid grid-cols-12">
      ...
      <div className="col-span-3 h-full border-l-2 border-secondary/20 px-10 pt-10">
        <div>
